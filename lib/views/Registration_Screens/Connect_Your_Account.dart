...
class Connect_Your_Account extends StatefulWidget {
  bool fromsetting;

  Connect_Your_Account({required this.fromsetting, super.key});

  @override
  State<Connect_Your_Account> createState() => _Connect_Your_AccountState();
}

class _Connect_Your_AccountState extends State<Connect_Your_Account> {
